 ...
 */
final class Version20190909131002 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE rapport_marketing (id INT AUTO_INCREMENT NOT NULL, is_one_to_one TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE marc_concurent ADD type_de_compagne_id INT DEFAULT NULL, ADD equipment_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE marc_concurent ADD CONSTRAINT FK_5B630FAC2C560E7A FOREIGN KEY (type_de_compagne_id) REFERENCES mark_type_de_compagne (id)');
        $this->addSql('ALTER TABLE marc_concurent ADD CONSTRAINT FK_5B630FAC517FE9FE FOREIGN KEY (equipment_id) REFERENCES mark_nouvel_equipement (id)');
        $this->addSql('CREATE INDEX IDX_5B630FAC2C560E7A ON marc_concurent (type_de_compagne_id)');
        $this->addSql('CREATE INDEX IDX_5B630FAC517FE9FE ON marc_concurent (equipment_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE rapport_marketing');
        ...
        $this->addSql('ALTER TABLE install_presentoire_jti CHANGE presentoire_id presentoire_id INT DEFAULT NULL, CHANGE is_installation is_installation TINYINT(1) DEFAULT \'NULL\', CHANGE quantiter quantiter INT DEFAULT NULL');
        $this->addSql('ALTER TABLE marc_concurent DROP FOREIGN KEY FK_5B630FAC2C560E7A');
        $this->addSql('ALTER TABLE marc_concurent DROP FOREIGN KEY FK_5B630FAC517FE9FE');
        $this->addSql('DROP INDEX IDX_5B630FAC2C560E7A ON marc_concurent');
        $this->addSql('DROP INDEX IDX_5B630FAC517FE9FE ON marc_concurent');
        $this->addSql('ALTER TABLE marc_concurent DROP type_de_compagne_id, DROP equipment_id');
