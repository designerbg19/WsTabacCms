 ...
 */
final class Version20190909131146 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE rapport_marketing_marc_concurent (rapport_marketing_id INT NOT NULL, marc_concurent_id INT NOT NULL, INDEX IDX_752DEDC5622AD9FF (rapport_marketing_id), INDEX IDX_752DEDC5E5004D42 (marc_concurent_id), PRIMARY KEY(rapport_marketing_id, marc_concurent_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE rapport_marketing_marc_concurent ADD CONSTRAINT FK_752DEDC5622AD9FF FOREIGN KEY (rapport_marketing_id) REFERENCES rapport_marketing (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE rapport_marketing_marc_concurent ADD CONSTRAINT FK_752DEDC5E5004D42 FOREIGN KEY (marc_concurent_id) REFERENCES marc_concurent (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE marc_concurent CHANGE type_de_compagne_id type_de_compagne_id INT DEFAULT NULL, CHANGE equipment_id equipment_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE rapport_marketing_marc_concurent');
