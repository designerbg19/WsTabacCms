 ...
 */
final class Version20190918094303 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE info_client CHANGE situation_famil_id situation_famil_id INT DEFAULT NULL, CHANGE age_client_id age_client_id INT DEFAULT NULL, CHANGE nbr_enfant_id nbr_enfant_id INT DEFAULT NULL, CHANGE type_client_new_id type_client_new_id INT DEFAULT NULL, CHANGE client_id client_id INT DEFAULT NULL, CHANGE telephone telephone VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE file ADD client_id INT DEFAULT NULL, CHANGE client_mini_report_id client_mini_report_id INT DEFAULT NULL, CHANGE label label VARCHAR(255) DEFAULT NULL, CHANGE path path VARCHAR(255) DEFAULT NULL, CHANGE classment classment VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE file ADD CONSTRAINT FK_8C9F361019EB6921 FOREIGN KEY (client_id) REFERENCES client (id)');
        $this->addSql('CREATE INDEX IDX_8C9F361019EB6921 ON file (client_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE des_install_presentoire_jti CHANGE presentoire_id presentoire_id INT DEFAULT NULL, CHANGE is_desinstall is_desinstall TINYINT(1) DEFAULT \'NULL\', CHANGE quantiter quantiter INT DEFAULT NULL');
        $this->addSql('ALTER TABLE desinstallation_presentoire_not_jti CHANGE is_desinstall is_desinstall TINYINT(1) DEFAULT \'NULL\', CHANGE quantiter quantiter INT DEFAULT NULL');
        $this->addSql('ALTER TABLE file DROP FOREIGN KEY FK_8C9F361019EB6921');
        $this->addSql('DROP INDEX IDX_8C9F361019EB6921 ON file');
        $this->addSql('ALTER TABLE file DROP client_id, CHANGE client_mini_report_id client_mini_report_id INT DEFAULT NULL, CHANGE label label VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE path path VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE classment classment VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
        $this->addSql('ALTER TABLE global_planning CHANGE day1 day1 INT DEFAULT NULL, CHANGE day2 day2 INT DEFAULT NULL, CHANGE day3 day3 INT DEFAULT NULL, CHANGE day4 day4 INT DEFAULT NULL, CHANGE day5 day5 INT DEFAULT NULL, CHANGE day6 day6 INT DEFAULT NULL, CHANGE day7 day7 INT DEFAULT NULL, CHANGE day8 day8 INT DEFAULT NULL, CHANGE day9 day9 INT DEFAULT NULL, CHANGE day10 day10 INT DEFAULT NULL, CHANGE day11 day11 INT DEFAULT NULL, CHANGE day12 day12 INT DEFAULT NULL, CHANGE day13 day13 INT DEFAULT NULL');
        $this->addSql('ALTER TABLE info_client CHANGE client_id client_id INT DEFAULT NULL, CHANGE situation_famil_id situation_famil_id INT DEFAULT NULL, CHANGE age_client_id age_client_id INT DEFAULT NULL, CHANGE nbr_enfant_id nbr_enfant_id INT DEFAULT NULL, CHANGE type_client_new_id type_client_new_id INT DEFAULT NULL, CHANGE telephone telephone VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
        $this->addSql('ALTER TABLE install_presentoire_jti CHANGE presentoire_id presentoire_id INT DEFAULT NULL, CHANGE is_installation is_installation TINYINT(1) DEFAULT \'NULL\', CHANGE quantiter quantiter INT DEFAULT NULL');
