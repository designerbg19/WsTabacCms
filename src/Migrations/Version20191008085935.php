 ...
 */
final class Version20191008085935 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE produit DROP stoke_produit_id, CHANGE typeproduit_id typeproduit_id INT DEFAULT NULL, CHANGE file_id file_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE presence_presentoire_not_jti CHANGE is_present is_present TINYINT(1) DEFAULT \'NULL\', CHANGE quantiter quantiter INT DEFAULT NULL');
        $this->addSql('ALTER TABLE presence_shop_jti CHANGE is_present is_present TINYINT(1) DEFAULT \'NULL\', CHANGE quantiter quantiter INT DEFAULT NULL');
        $this->addSql('ALTER TABLE produit ADD stoke_produit_id INT DEFAULT NULL, CHANGE typeproduit_id typeproduit_id INT DEFAULT NULL, CHANGE file_id file_id INT DEFAULT NULL');
