 ...
 */
final class Version20190909155621 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE rapport_marketing_pdv_tposm (rapport_marketing_id INT NOT NULL, pdv_tposm_id INT NOT NULL, INDEX IDX_41C126C3622AD9FF (rapport_marketing_id), INDEX IDX_41C126C33AC08274 (pdv_tposm_id), PRIMARY KEY(rapport_marketing_id, pdv_tposm_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE rapport_marketing_pdv_tposm ADD CONSTRAINT FK_41C126C3622AD9FF FOREIGN KEY (rapport_marketing_id) REFERENCES rapport_marketing (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE rapport_marketing_pdv_tposm ADD CONSTRAINT FK_41C126C33AC08274 FOREIGN KEY (pdv_tposm_id) REFERENCES pdv_tposm (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE rapport_marketing_pdv_tposm');
