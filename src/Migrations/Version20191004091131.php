 ...
 */
final class Version20191004091131 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE rapport_global (id INT AUTO_INCREMENT NOT NULL, rapport_pdv_id INT DEFAULT NULL, rapport_pposm_id INT DEFAULT NULL, rapport_tposm_id INT DEFAULT NULL, rapport_tlp_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_894E4649604D5347 (rapport_pdv_id), UNIQUE INDEX UNIQ_894E4649E6466A3C (rapport_pposm_id), UNIQUE INDEX UNIQ_894E4649620C64C6 (rapport_tposm_id), UNIQUE INDEX UNIQ_894E4649EEC7054C (rapport_tlp_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE rapport_global ADD CONSTRAINT FK_894E4649604D5347 FOREIGN KEY (rapport_pdv_id) REFERENCES client (id)');
        $this->addSql('ALTER TABLE rapport_global ADD CONSTRAINT FK_894E4649E6466A3C FOREIGN KEY (rapport_pposm_id) REFERENCES rapport_pposm (id)');
        $this->addSql('ALTER TABLE rapport_global ADD CONSTRAINT FK_894E4649620C64C6 FOREIGN KEY (rapport_tposm_id) REFERENCES rapport_tposm (id)');
        $this->addSql('ALTER TABLE rapport_global ADD CONSTRAINT FK_894E4649EEC7054C FOREIGN KEY (rapport_tlp_id) REFERENCES rapport_tlp (id)');
        ...
        $this->addSql('ALTER TABLE rapport_produit ADD rapport_global_id INT DEFAULT NULL, CHANGE is_veder is_veder TINYINT(1) DEFAULT NULL');
        $this->addSql('ALTER TABLE rapport_produit ADD CONSTRAINT FK_52758C442E4DF7E2 FOREIGN KEY (rapport_global_id) REFERENCES rapport_global (id)');
        $this->addSql('CREATE INDEX IDX_52758C442E4DF7E2 ON rapport_produit (rapport_global_id)');
        ...
        $this->addSql('ALTER TABLE rapport_marketing ADD rapport_maintenance_id INT DEFAULT NULL, CHANGE type_de_compagnie_id type_de_compagnie_id INT DEFAULT NULL, CHANGE nouvel_equipment_id nouvel_equipment_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE rapport_marketing ADD CONSTRAINT FK_97E3438471A3035A FOREIGN KEY (rapport_maintenance_id) REFERENCES rapport_global (id)');
        $this->addSql('CREATE INDEX IDX_97E3438471A3035A ON rapport_marketing (rapport_maintenance_id)');
        $this->addSql('ALTER TABLE commentaire CHANGE type_id type_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rapport_produit DROP FOREIGN KEY FK_52758C442E4DF7E2');
        $this->addSql('ALTER TABLE rapport_marketing DROP FOREIGN KEY FK_97E3438471A3035A');
        ...
        $this->addSql('DROP TABLE rapport_global');
        ...
        $this->addSql('DROP INDEX IDX_97E3438471A3035A ON rapport_marketing');
        $this->addSql('ALTER TABLE rapport_marketing DROP rapport_maintenance_id, CHANGE type_de_compagnie_id type_de_compagnie_id INT DEFAULT NULL, CHANGE nouvel_equipment_id nouvel_equipment_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE rapport_pposm CHANGE client_id client_id INT DEFAULT NULL, CHANGE merch_id merch_id INT DEFAULT NULL, CHANGE install_presentoire_jti_id install_presentoire_jti_id INT DEFAULT NULL, CHANGE des_install_presentoire_jti_id des_install_presentoire_jti_id INT DEFAULT NULL, CHANGE presence_presentoire_jti_id presence_presentoire_jti_id INT DEFAULT NULL');
        $this->addSql('DROP INDEX IDX_52758C442E4DF7E2 ON rapport_produit');
        $this->addSql('ALTER TABLE rapport_produit DROP rapport_global_id, CHANGE is_veder is_veder TINYINT(1) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE rapport_tposm CHANGE presence_nbr_article_id presence_nbr_article_id INT DEFAULT NULL, CHANGE installation_nbr_id installation_nbr_id INT DEFAULT NULL, CHANGE instalation_raison_id instalation_raison_id INT DEFAULT NULL');
