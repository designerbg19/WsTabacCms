 ...
 */
final class Version20191016141508 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE stoke CHANGE quantiter quantiter INT DEFAULT NULL');
