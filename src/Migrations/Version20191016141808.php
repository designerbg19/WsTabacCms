 ...
 */
final class Version20191016141808 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE stoke ADD stoke_container_id INT DEFAULT NULL, ADD produit_id INT DEFAULT NULL, CHANGE quantiter quantiter INT DEFAULT NULL');
        $this->addSql('ALTER TABLE stoke ADD CONSTRAINT FK_6457F16F99585456 FOREIGN KEY (stoke_container_id) REFERENCES stoke_container (id)');
        $this->addSql('ALTER TABLE stoke ADD CONSTRAINT FK_6457F16FF347EFB FOREIGN KEY (produit_id) REFERENCES produit (id)');
        $this->addSql('CREATE INDEX IDX_6457F16F99585456 ON stoke (stoke_container_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_6457F16FF347EFB ON stoke (produit_id)');
        ...
        $this->addSql('ALTER TABLE user CHANGE user_name_admin user_name_admin VARCHAR(255) DEFAULT NULL, CHANGE roles roles LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\'');
        ...
        $this->addSql('ALTER TABLE file CHANGE client_mini_report_id client_mini_report_id INT DEFAULT NULL, CHANGE client_id client_id INT DEFAULT NULL, CHANGE label label VARCHAR(255) DEFAULT NULL, CHANGE classment classment INT DEFAULT NULL');
        $this->addSql('ALTER TABLE pdv_ppsom CHANGE ppsom ppsom VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE merch CHANGE region_id region_id INT DEFAULT NULL, CHANGE roles roles LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', CHANGE path_image path_image VARCHAR(255) DEFAULT NULL, CHANGE image_name image_name VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE pdv_presentoire CHANGE image_id image_id INT DEFAULT NULL, CHANGE maison_maire_id maison_maire_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE des_install_presentoire_jti CHANGE presentoire_id presentoire_id INT DEFAULT NULL, CHANGE is_desinstall is_desinstall TINYINT(1) DEFAULT \'NULL\', CHANGE quantiter quantiter INT DEFAULT NULL');
        $this->addSql('ALTER TABLE desinstallation_presentoire_not_jti CHANGE is_desinstall is_desinstall TINYINT(1) DEFAULT \'NULL\', CHANGE quantiter quantiter INT DEFAULT NULL');
        $this->addSql('ALTER TABLE file CHANGE client_mini_report_id client_mini_report_id INT DEFAULT NULL, CHANGE client_id client_id INT DEFAULT NULL, CHANGE label label VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE classment classment INT DEFAULT NULL');
        $this->addSql('ALTER TABLE global_planning CHANGE day1 day1 INT DEFAULT NULL, CHANGE day2 day2 INT DEFAULT NULL, CHANGE day3 day3 INT DEFAULT NULL, CHANGE day4 day4 INT DEFAULT NULL, CHANGE day5 day5 INT DEFAULT NULL, CHANGE day6 day6 INT DEFAULT NULL, CHANGE day7 day7 INT DEFAULT NULL, CHANGE day8 day8 INT DEFAULT NULL, CHANGE day9 day9 INT DEFAULT NULL, CHANGE day10 day10 INT DEFAULT NULL, CHANGE day11 day11 INT DEFAULT NULL, CHANGE day12 day12 INT DEFAULT NULL, CHANGE day13 day13 INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE merch CHANGE region_id region_id INT DEFAULT NULL, CHANGE path_image path_image VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE image_name image_name VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE roles roles LONGTEXT DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:array)\'');
        ...
        $this->addSql('ALTER TABLE presence_presentoire_not_jti CHANGE is_present is_present TINYINT(1) DEFAULT \'NULL\', CHANGE quantiter quantiter INT DEFAULT NULL');
        $this->addSql('ALTER TABLE presence_shop_jti CHANGE is_present is_present TINYINT(1) DEFAULT \'NULL\', CHANGE quantiter quantiter INT DEFAULT NULL');
        $this->addSql('ALTER TABLE produit CHANGE typeproduit_id typeproduit_id INT DEFAULT NULL, CHANGE file_id file_id INT DEFAULT NULL, CHANGE stoke stoke INT DEFAULT NULL, CHANGE is_visible is_visible TINYINT(1) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE quantiter_type_plv CHANGE quantiter quantiter INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE stoke DROP FOREIGN KEY FK_6457F16F99585456');
        $this->addSql('ALTER TABLE stoke DROP FOREIGN KEY FK_6457F16FF347EFB');
        $this->addSql('DROP INDEX IDX_6457F16F99585456 ON stoke');
        $this->addSql('DROP INDEX UNIQ_6457F16FF347EFB ON stoke');
        $this->addSql('ALTER TABLE stoke DROP stoke_container_id, DROP produit_id, CHANGE quantiter quantiter INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE user CHANGE user_name_admin user_name_admin VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE roles roles LONGTEXT DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:array)\'');
    }
}
