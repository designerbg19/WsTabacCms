 ...
 */
final class Version20191004112436 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rapport_global ADD merch_id INT DEFAULT NULL, ADD date_rappoort VARCHAR(255) DEFAULT NULL, ADD durre VARCHAR(255) DEFAULT NULL, CHANGE rapport_pdv_id rapport_pdv_id INT DEFAULT NULL, CHANGE rapport_pposm_id rapport_pposm_id INT DEFAULT NULL, CHANGE rapport_tposm_id rapport_tposm_id INT DEFAULT NULL, CHANGE rapport_tlp_id rapport_tlp_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE rapport_global ADD CONSTRAINT FK_894E46498A86BD8 FOREIGN KEY (merch_id) REFERENCES merch (id)');
        $this->addSql('CREATE INDEX IDX_894E46498A86BD8 ON rapport_global (merch_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rapport_global DROP FOREIGN KEY FK_894E46498A86BD8');
        $this->addSql('DROP INDEX IDX_894E46498A86BD8 ON rapport_global');
        $this->addSql('ALTER TABLE rapport_global DROP merch_id, DROP date_rappoort, DROP durre, CHANGE rapport_pdv_id rapport_pdv_id INT DEFAULT NULL, CHANGE rapport_pposm_id rapport_pposm_id INT DEFAULT NULL, CHANGE rapport_tposm_id rapport_tposm_id INT DEFAULT NULL, CHANGE rapport_tlp_id rapport_tlp_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE rapport_maintenance CHANGE rapport_global_id rapport_global_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE rapport_marketing CHANGE type_de_compagnie_id type_de_compagnie_id INT DEFAULT NULL, CHANGE nouvel_equipment_id nouvel_equipment_id INT DEFAULT NULL, CHANGE rapport_global_id rapport_global_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE rapport_pposm CHANGE client_id client_id INT DEFAULT NULL, CHANGE merch_id merch_id INT DEFAULT NULL, CHANGE install_presentoire_jti_id install_presentoire_jti_id INT DEFAULT NULL, CHANGE des_install_presentoire_jti_id des_install_presentoire_jti_id INT DEFAULT NULL, CHANGE presence_presentoire_jti_id presence_presentoire_jti_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE rapport_produit CHANGE rapport_global_id rapport_global_id INT DEFAULT NULL, CHANGE is_veder is_veder TINYINT(1) DEFAULT \'NULL\'');
