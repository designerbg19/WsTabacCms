 ...
 */
final class Version20190911140948 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tlp_stoke_courant DROP quantiter');
        ...
        $this->addSql('ALTER TABLE new_install_pdv ADD comment VARCHAR(255) DEFAULT NULL, DROP merch_response_status, CHANGE waiting_time waiting_time VARCHAR(255) DEFAULT NULL, CHANGE code_client code_client VARCHAR(255) DEFAULT NULL, CHANGE licence licence VARCHAR(255) DEFAULT NULL, CHANGE adress adress VARCHAR(255) DEFAULT NULL, CHANGE titulairenom titulairenom VARCHAR(255) DEFAULT NULL, CHANGE titulairetel titulairetel VARCHAR(255) DEFAULT NULL, CHANGE gerantnom gerantnom VARCHAR(255) DEFAULT NULL, CHANGE geranttel geranttel VARCHAR(255) DEFAULT NULL, CHANGE operateurnom operateurnom VARCHAR(255) DEFAULT NULL, CHANGE operateurtel operateurtel VARCHAR(255) DEFAULT NULL, CHANGE cin cin VARCHAR(255) DEFAULT NULL, CHANGE code_postal code_postal VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE survey CHANGE cycle cycle INT DEFAULT NULL');
        $this->addSql('ALTER TABLE tlp_stoke_courant ADD quantiter INT NOT NULL');
