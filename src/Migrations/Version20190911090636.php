 ...
 */
final class Version20190911090636 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE rapport_maint_list_ma (id INT AUTO_INCREMENT NOT NULL, diffintion VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE rapport_maintenance (id INT AUTO_INCREMENT NOT NULL, is_maintenance TINYINT(1) NOT NULL, explication VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE list_install_pdv (id INT AUTO_INCREMENT NOT NULL, new_install_id INT NOT NULL, titulaire_nom VARCHAR(255) NOT NULL, gouvernorat_id INT NOT NULL, quartier_id INT NOT NULL, status_new_install INT NOT NULL, merch_id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE new_install_pdv (id INT AUTO_INCREMENT NOT NULL, status_new_install INT NOT NULL, merch_id INT NOT NULL, new_install_date DATETIME NOT NULL, created_at DATETIME NOT NULL, longitude NUMERIC(10, 0) NOT NULL, latitude NUMERIC(10, 0) NOT NULL, waiting_time VARCHAR(255) DEFAULT NULL, code_client VARCHAR(255) DEFAULT NULL, licence VARCHAR(255) DEFAULT NULL, adress VARCHAR(255) DEFAULT NULL, decideur_id INT NOT NULL, titulairenom VARCHAR(255) DEFAULT NULL, titulairetel VARCHAR(255) DEFAULT NULL, titulairesituation_id INT NOT NULL, titulairenbrenf_id INT NOT NULL, titulaireage_id INT NOT NULL, gerantnom VARCHAR(255) DEFAULT NULL, geranttel VARCHAR(255) DEFAULT NULL, gerantsituation_id INT NOT NULL, gerantnbrenf_id INT NOT NULL, gerantage_id INT NOT NULL, operateurnom VARCHAR(255) DEFAULT NULL, operateurtel VARCHAR(255) DEFAULT NULL, cin VARCHAR(255) DEFAULT NULL, region_id INT NOT NULL, zone_id INT NOT NULL, gouvernorat_id INT NOT NULL, delegation_id INT NOT NULL, quartier_id INT NOT NULL, code_postal VARCHAR(255) DEFAULT NULL, superficie_id INT NOT NULL, nbremployes_id INT NOT NULL, emplacement_id INT NOT NULL, environnement_id INT NOT NULL, typequartier_id INT NOT NULL, visibilite_id INT NOT NULL, classe_id INT NOT NULL, typologie_id INT NOT NULL, is_access_pdv TINYINT(1) NOT NULL, presentoir_jti_id INT NOT NULL, is_onetoone TINYINT(1) NOT NULL, regie_tabac_id INT NOT NULL, recetteprincipal_id INT NOT NULL, recettescecondaire_id INT NOT NULL, is_tlp TINYINT(1) NOT NULL, is_fs_potentiel TINYINT(1) NOT NULL, compagne_id INT NOT NULL, merch_response_status INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE client_mini_report ADD closed_reason_id INT DEFAULT NULL, ADD closed_reason_autre VARCHAR(255) DEFAULT NULL, DROP closed_reason');
        ...
        $this->addSql('ALTER TABLE rapport_marketing CHANGE type_de_compagnie_id type_de_compagnie_id INT DEFAULT NULL, CHANGE nouvel_equipment_id nouvel_equipment_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE marc_concurent_pdv_tposm (marc_concurent_id INT NOT NULL, pdv_tposm_id INT NOT NULL, INDEX IDX_7D6BE5D1E5004D42 (marc_concurent_id), INDEX IDX_7D6BE5D13AC08274 (pdv_tposm_id), PRIMARY KEY(marc_concurent_id, pdv_tposm_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('DROP TABLE rapport_maint_list_ma');
        $this->addSql('DROP TABLE rapport_maintenance');
        $this->addSql('DROP TABLE list_install_pdv');
        $this->addSql('DROP TABLE new_install_pdv');
        ...
        $this->addSql('ALTER TABLE client_mini_report ADD closed_reason VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, DROP closed_reason_id, DROP closed_reason_autre');
        $this->addSql('ALTER TABLE des_install_presentoire_jti CHANGE presentoire_id presentoire_id INT DEFAULT NULL, CHANGE is_desinstall is_desinstall TINYINT(1) DEFAULT \'NULL\', CHANGE quantiter quantiter INT DEFAULT NULL');
        $this->addSql('ALTER TABLE desinstallation_presentoire_not_jti CHANGE is_desinstall is_desinstall TINYINT(1) DEFAULT \'NULL\', CHANGE quantiter quantiter INT DEFAULT NULL');
        $this->addSql('ALTER TABLE global_planning CHANGE day1 day1 INT DEFAULT NULL, CHANGE day2 day2 INT DEFAULT NULL, CHANGE day3 day3 INT DEFAULT NULL, CHANGE day4 day4 INT DEFAULT NULL, CHANGE day5 day5 INT DEFAULT NULL, CHANGE day6 day6 INT DEFAULT NULL, CHANGE day7 day7 INT DEFAULT NULL, CHANGE day8 day8 INT DEFAULT NULL, CHANGE day9 day9 INT DEFAULT NULL, CHANGE day10 day10 INT DEFAULT NULL, CHANGE day11 day11 INT DEFAULT NULL, CHANGE day12 day12 INT DEFAULT NULL, CHANGE day13 day13 INT DEFAULT NULL');
