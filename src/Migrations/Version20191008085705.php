 ...
 */
final class Version20191008085705 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD stoke_produit_id INT DEFAULT NULL, DROP stoke, CHANGE typeproduit_id typeproduit_id INT DEFAULT NULL, CHANGE file_id file_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE produit ADD CONSTRAINT FK_29A5EC27124F8924 FOREIGN KEY (stoke_produit_id) REFERENCES stoke (id)');
        $this->addSql('CREATE INDEX IDX_29A5EC27124F8924 ON produit (stoke_produit_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE presence_presentoire_not_jti CHANGE is_present is_present TINYINT(1) DEFAULT \'NULL\', CHANGE quantiter quantiter INT DEFAULT NULL');
        $this->addSql('ALTER TABLE presence_shop_jti CHANGE is_present is_present TINYINT(1) DEFAULT \'NULL\', CHANGE quantiter quantiter INT DEFAULT NULL');
        $this->addSql('ALTER TABLE produit DROP FOREIGN KEY FK_29A5EC27124F8924');
        $this->addSql('DROP INDEX IDX_29A5EC27124F8924 ON produit');
        $this->addSql('ALTER TABLE produit ADD stoke INT DEFAULT NULL, DROP stoke_produit_id, CHANGE typeproduit_id typeproduit_id INT DEFAULT NULL, CHANGE file_id file_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE quantiter_type_plv CHANGE quantiter quantiter INT DEFAULT NULL');
