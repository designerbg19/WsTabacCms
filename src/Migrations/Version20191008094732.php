 ...
 */
final class Version20191008094732 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE stoke_client (stoke_id INT NOT NULL, client_id INT NOT NULL, INDEX IDX_A33066E9DD625DE2 (stoke_id), INDEX IDX_A33066E919EB6921 (client_id), PRIMARY KEY(stoke_id, client_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE stoke_client ADD CONSTRAINT FK_A33066E9DD625DE2 FOREIGN KEY (stoke_id) REFERENCES stoke (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE stoke_client ADD CONSTRAINT FK_A33066E919EB6921 FOREIGN KEY (client_id) REFERENCES client (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE stoke_client');
