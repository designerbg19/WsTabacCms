 ...
 */
final class Version20191008094632 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE stoke_produit (stoke_id INT NOT NULL, produit_id INT NOT NULL, INDEX IDX_EB1667E2DD625DE2 (stoke_id), INDEX IDX_EB1667E2F347EFB (produit_id), PRIMARY KEY(stoke_id, produit_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE stoke_produit ADD CONSTRAINT FK_EB1667E2DD625DE2 FOREIGN KEY (stoke_id) REFERENCES stoke (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE stoke_produit ADD CONSTRAINT FK_EB1667E2F347EFB FOREIGN KEY (produit_id) REFERENCES produit (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE stoke_produit');
