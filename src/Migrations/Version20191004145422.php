 ...
 */
final class Version20191004145422 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE commentaire ADD rapport_pposm_id INT DEFAULT NULL, CHANGE type_id type_id INT DEFAULT NULL, CHANGE client_id client_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE commentaire ADD CONSTRAINT FK_67F068BCE6466A3C FOREIGN KEY (rapport_pposm_id) REFERENCES rapport_pposm (id)');
        $this->addSql('CREATE INDEX IDX_67F068BCE6466A3C ON commentaire (rapport_pposm_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE commentaire DROP FOREIGN KEY FK_67F068BCE6466A3C');
        $this->addSql('DROP INDEX IDX_67F068BCE6466A3C ON commentaire');
        $this->addSql('ALTER TABLE commentaire DROP rapport_pposm_id, CHANGE type_id type_id INT DEFAULT NULL, CHANGE client_id client_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE des_install_presentoire_jti CHANGE presentoire_id presentoire_id INT DEFAULT NULL, CHANGE is_desinstall is_desinstall TINYINT(1) DEFAULT \'NULL\', CHANGE quantiter quantiter INT DEFAULT NULL');
        $this->addSql('ALTER TABLE desinstallation_presentoire_not_jti CHANGE is_desinstall is_desinstall TINYINT(1) DEFAULT \'NULL\', CHANGE quantiter quantiter INT DEFAULT NULL');
