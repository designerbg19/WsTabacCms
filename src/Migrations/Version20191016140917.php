 ...
 */
final class Version20191016140917 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE stoke DROP FOREIGN KEY FK_6457F16F5967CE0F');
        $this->addSql('DROP TABLE marc_concurent_pdv_tposm');
        $this->addSql('DROP TABLE stoke');
        $this->addSql('DROP TABLE stoke_refernce');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE stoke (id INT AUTO_INCREMENT NOT NULL, stoke_refernce_id INT DEFAULT NULL, quantiter INT NOT NULL, quantiter_produit_id INT DEFAULT NULL, INDEX IDX_6457F16F5967CE0F (stoke_refernce_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE stoke_refernce (id INT AUTO_INCREMENT NOT NULL, client_stoke_refernce_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_C61D9886732C2C1E (client_stoke_refernce_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE stoke ADD CONSTRAINT FK_6457F16F5967CE0F FOREIGN KEY (stoke_refernce_id) REFERENCES stoke_refernce (id)');
        $this->addSql('ALTER TABLE stoke_refernce ADD CONSTRAINT FK_C61D9886732C2C1E FOREIGN KEY (client_stoke_refernce_id) REFERENCES client (id)');
