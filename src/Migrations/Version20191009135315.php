 ...
 */
final class Version20191009135315 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE merch_notification (merch_id INT NOT NULL, notification_id INT NOT NULL, INDEX IDX_AA4A096A8A86BD8 (merch_id), INDEX IDX_AA4A096AEF1A9D84 (notification_id), PRIMARY KEY(merch_id, notification_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE merch_notification ADD CONSTRAINT FK_AA4A096A8A86BD8 FOREIGN KEY (merch_id) REFERENCES merch (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE merch_notification ADD CONSTRAINT FK_AA4A096AEF1A9D84 FOREIGN KEY (notification_id) REFERENCES notification (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE produit DROP stoke, CHANGE typeproduit_id typeproduit_id INT DEFAULT NULL, CHANGE file_id file_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE pdv_presentoire ADD maison_maire_id INT DEFAULT NULL, CHANGE image_id image_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE pdv_presentoire ADD CONSTRAINT FK_CB0538AD5C54056A FOREIGN KEY (maison_maire_id) REFERENCES praisontoir_maison_de_maire (id)');
        $this->addSql('CREATE INDEX IDX_CB0538AD5C54056A ON pdv_presentoire (maison_maire_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE merch_notification');
        ...
        $this->addSql('ALTER TABLE pdv_presentoire DROP FOREIGN KEY FK_CB0538AD5C54056A');
        $this->addSql('DROP INDEX IDX_CB0538AD5C54056A ON pdv_presentoire');
        $this->addSql('ALTER TABLE pdv_presentoire DROP maison_maire_id, CHANGE image_id image_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE presence_presentoire_not_jti CHANGE is_present is_present TINYINT(1) DEFAULT \'NULL\', CHANGE quantiter quantiter INT DEFAULT NULL');
        $this->addSql('ALTER TABLE presence_shop_jti CHANGE is_present is_present TINYINT(1) DEFAULT \'NULL\', CHANGE quantiter quantiter INT DEFAULT NULL');
        $this->addSql('ALTER TABLE produit ADD stoke INT DEFAULT NULL, CHANGE typeproduit_id typeproduit_id INT DEFAULT NULL, CHANGE file_id file_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE quantiter_type_plv CHANGE quantiter quantiter INT DEFAULT NULL');
