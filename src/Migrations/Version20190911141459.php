 ...
 */
final class Version20190911141459 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE tlp_stoke_courant_produit (tlp_stoke_courant_id INT NOT NULL, produit_id INT NOT NULL, INDEX IDX_9746E00CECB2BF95 (tlp_stoke_courant_id), INDEX IDX_9746E00CF347EFB (produit_id), PRIMARY KEY(tlp_stoke_courant_id, produit_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE tlp_stoke_courant_produit ADD CONSTRAINT FK_9746E00CECB2BF95 FOREIGN KEY (tlp_stoke_courant_id) REFERENCES tlp_stoke_courant (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE tlp_stoke_courant_produit ADD CONSTRAINT FK_9746E00CF347EFB FOREIGN KEY (produit_id) REFERENCES produit (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE tlp_stoke_courant_produit');
