 ...
 */
final class Version20191007091703 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE rapport_tposm_commentaire (rapport_tposm_id INT NOT NULL, commentaire_id INT NOT NULL, INDEX IDX_40BD1EF620C64C6 (rapport_tposm_id), INDEX IDX_40BD1EFBA9CD190 (commentaire_id), PRIMARY KEY(rapport_tposm_id, commentaire_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE rapport_tposm_commentaire ADD CONSTRAINT FK_40BD1EF620C64C6 FOREIGN KEY (rapport_tposm_id) REFERENCES rapport_tposm (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE rapport_tposm_commentaire ADD CONSTRAINT FK_40BD1EFBA9CD190 FOREIGN KEY (commentaire_id) REFERENCES commentaire (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE rapport_tposm_commentaire');
        $this->addSql('ALTER TABLE age CHANGE age age VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
        $this->addSql('DROP INDEX UNIQ_C7440455B8C25CF7 ON client');
