 ...
 */
final class Version20191004091714 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rapport_maintenance ADD rapport_global_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE rapport_maintenance ADD CONSTRAINT FK_82F068F2E4DF7E2 FOREIGN KEY (rapport_global_id) REFERENCES rapport_global (id)');
        $this->addSql('CREATE INDEX IDX_82F068F2E4DF7E2 ON rapport_maintenance (rapport_global_id)');
        $this->addSql('ALTER TABLE rapport_global CHANGE rapport_pdv_id rapport_pdv_id INT DEFAULT NULL, CHANGE rapport_pposm_id rapport_pposm_id INT DEFAULT NULL, CHANGE rapport_tposm_id rapport_tposm_id INT DEFAULT NULL, CHANGE rapport_tlp_id rapport_tlp_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE rapport_marketing ADD rapport_global_id INT DEFAULT NULL, DROP rapport_maintenance_id, CHANGE type_de_compagnie_id type_de_compagnie_id INT DEFAULT NULL, CHANGE nouvel_equipment_id nouvel_equipment_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE rapport_marketing ADD CONSTRAINT FK_97E343842E4DF7E2 FOREIGN KEY (rapport_global_id) REFERENCES rapport_global (id)');
        $this->addSql('CREATE INDEX IDX_97E343842E4DF7E2 ON rapport_marketing (rapport_global_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rapport_global CHANGE rapport_pdv_id rapport_pdv_id INT DEFAULT NULL, CHANGE rapport_pposm_id rapport_pposm_id INT DEFAULT NULL, CHANGE rapport_tposm_id rapport_tposm_id INT DEFAULT NULL, CHANGE rapport_tlp_id rapport_tlp_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE rapport_maintenance DROP FOREIGN KEY FK_82F068F2E4DF7E2');
        $this->addSql('DROP INDEX IDX_82F068F2E4DF7E2 ON rapport_maintenance');
        $this->addSql('ALTER TABLE rapport_maintenance DROP rapport_global_id');
        $this->addSql('ALTER TABLE rapport_marketing DROP FOREIGN KEY FK_97E343842E4DF7E2');
        $this->addSql('DROP INDEX IDX_97E343842E4DF7E2 ON rapport_marketing');
        $this->addSql('ALTER TABLE rapport_marketing ADD rapport_maintenance_id INT DEFAULT NULL, DROP rapport_global_id, CHANGE type_de_compagnie_id type_de_compagnie_id INT DEFAULT NULL, CHANGE nouvel_equipment_id nouvel_equipment_id INT DEFAULT NULL');
