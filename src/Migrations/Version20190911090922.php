 ...
 */
final class Version20190911090922 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE rapport_maintenance_rapport_maint_list_ma (rapport_maintenance_id INT NOT NULL, rapport_maint_list_ma_id INT NOT NULL, INDEX IDX_B1429BAC71A3035A (rapport_maintenance_id), INDEX IDX_B1429BACC5C1F823 (rapport_maint_list_ma_id), PRIMARY KEY(rapport_maintenance_id, rapport_maint_list_ma_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE rapport_maintenance_rapport_maint_list_ma ADD CONSTRAINT FK_B1429BAC71A3035A FOREIGN KEY (rapport_maintenance_id) REFERENCES rapport_maintenance (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE rapport_maintenance_rapport_maint_list_ma ADD CONSTRAINT FK_B1429BACC5C1F823 FOREIGN KEY (rapport_maint_list_ma_id) REFERENCES rapport_maint_list_ma (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE rapport_maintenance_rapport_maint_list_ma');
