 ...
 */
final class Version20190909154935 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rapport_marketing ADD type_de_compagnie_id INT DEFAULT NULL, ADD nouvel_equipment_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE rapport_marketing ADD CONSTRAINT FK_97E34384E70F964B FOREIGN KEY (type_de_compagnie_id) REFERENCES mark_type_de_compagne (id)');
        $this->addSql('ALTER TABLE rapport_marketing ADD CONSTRAINT FK_97E34384FB61F946 FOREIGN KEY (nouvel_equipment_id) REFERENCES mark_nouvel_equipement (id)');
        $this->addSql('CREATE INDEX IDX_97E34384E70F964B ON rapport_marketing (type_de_compagnie_id)');
        $this->addSql('CREATE INDEX IDX_97E34384FB61F946 ON rapport_marketing (nouvel_equipment_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rapport_marketing DROP FOREIGN KEY FK_97E34384E70F964B');
        $this->addSql('ALTER TABLE rapport_marketing DROP FOREIGN KEY FK_97E34384FB61F946');
        $this->addSql('DROP INDEX IDX_97E34384E70F964B ON rapport_marketing');
        $this->addSql('DROP INDEX IDX_97E34384FB61F946 ON rapport_marketing');
        $this->addSql('ALTER TABLE rapport_marketing DROP type_de_compagnie_id, DROP nouvel_equipment_id');
        $this->addSql('ALTER TABLE rapport_pposm CHANGE client_id client_id INT DEFAULT NULL, CHANGE merch_id merch_id INT DEFAULT NULL, CHANGE install_presentoire_jti_id install_presentoire_jti_id INT DEFAULT NULL, CHANGE des_install_presentoire_jti_id des_install_presentoire_jti_id INT DEFAULT NULL, CHANGE presence_presentoire_jti_id presence_presentoire_jti_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE rapport_produit CHANGE is_veder is_veder TINYINT(1) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE rapport_tposm CHANGE presence_nbr_article_id presence_nbr_article_id INT DEFAULT NULL, CHANGE installation_nbr_id installation_nbr_id INT DEFAULT NULL, CHANGE instalation_raison_id instalation_raison_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE routing CHANGE zone_id zone_id INT DEFAULT NULL, CHANGE merch_id merch_id INT DEFAULT NULL');
