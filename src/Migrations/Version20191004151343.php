 ...
 */
final class Version20191004151343 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE commentaire ADD rapport_tlp_id INT DEFAULT NULL, CHANGE type_id type_id INT DEFAULT NULL, CHANGE client_id client_id INT DEFAULT NULL, CHANGE rapport_pposm_id rapport_pposm_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE commentaire ADD CONSTRAINT FK_67F068BCEEC7054C FOREIGN KEY (rapport_tlp_id) REFERENCES rapport_tlp (id)');
        $this->addSql('CREATE INDEX IDX_67F068BCEEC7054C ON commentaire (rapport_tlp_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE commentaire DROP FOREIGN KEY FK_67F068BCEEC7054C');
        $this->addSql('DROP INDEX IDX_67F068BCEEC7054C ON commentaire');
        $this->addSql('ALTER TABLE commentaire DROP rapport_tlp_id, CHANGE type_id type_id INT DEFAULT NULL, CHANGE client_id client_id INT DEFAULT NULL, CHANGE rapport_pposm_id rapport_pposm_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE des_install_presentoire_jti CHANGE presentoire_id presentoire_id INT DEFAULT NULL, CHANGE is_desinstall is_desinstall TINYINT(1) DEFAULT \'NULL\', CHANGE quantiter quantiter INT DEFAULT NULL');
        $this->addSql('ALTER TABLE desinstallation_presentoire_not_jti CHANGE is_desinstall is_desinstall TINYINT(1) DEFAULT \'NULL\', CHANGE quantiter quantiter INT DEFAULT NULL');
