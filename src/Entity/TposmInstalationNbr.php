...
/**
 * @ORM\Entity(repositoryClass="App\Repository\TposmInstalationNbrRepository")
 */
class TposmInstalationNbr
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    public function addRapportTposm(RapportTposm $rapportTposm): self
    {
        if (!$this->rapportTposms->contains($rapportTposm)) {
            ...
            $rapportTposm->setInstallationNbr($this);
        }
    ...
    public function removeRapportTposm(RapportTposm $rapportTposm): self
    {
        if ($this->rapportTposms->contains($rapportTposm)) {
            ...
            if ($rapportTposm->getInstallationNbr() === $this) {
                $rapportTposm->setInstallationNbr(null);
            }
        }
