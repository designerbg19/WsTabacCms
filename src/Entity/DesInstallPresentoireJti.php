...
/**
 * @ORM\Entity(repositoryClass="App\Repository\DesInstallPresentoireJtiRepository")
 */
class DesInstallPresentoireJti
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\PdvPresentoire", inversedBy="desInstallPresentoireJtis")
     */
    private $presentoire;
    ...
    public function addRapportPPOSM(RapportPPOSM $rapportPPOSM): self
    {
        if (!$this->rapportPPOSMs->contains($rapportPPOSM)) {
            ...
            $rapportPPOSM->setDesInstallPresentoireJti($this);
        }
    ...
    public function removeRapportPPOSM(RapportPPOSM $rapportPPOSM): self
    {
        if ($this->rapportPPOSMs->contains($rapportPPOSM)) {
            ...
            if ($rapportPPOSM->getDesInstallPresentoireJti() === $this) {
                $rapportPPOSM->setDesInstallPresentoireJti(null);
            }
        }
